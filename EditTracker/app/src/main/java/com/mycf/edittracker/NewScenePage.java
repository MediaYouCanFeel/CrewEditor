...
public class NewScenePage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button newSceneCreateButton = (Button) findViewById(R.id.new_scene_create_button);
        Button newSceneCancelButton = (Button) findViewById(R.id.new_scene_cancel_button);
